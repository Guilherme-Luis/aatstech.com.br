...
<body>
    ...
    <center> <h1>Painel do Site</h1> <hr /> </center>
    <div id="autenticao" class="container">
        ...
        <div class="row row-cols-1 row-cols-md-3 mb-3 ">
          ...
          <div class="col-lg-10">
            <div class="card mb-4 shadow-sm">
            <div class="card-header">
              <h4 class="my-0 fw-normal">Últimas Dúdivas ou Sugestões</h4>
            </div>
            <div class="card-body">
             <form action="verifica_login.php">
              <ul class="list-unstyled mt-3 mb-4">
              <?php
                 ...
                 $sql = "select * from formulario order by codForm desc";
                    $retorno = $con->query($sql);
                      if( $retorno->num_rows > 0){
                            if( $registro = $retorno->fetch_assoc() ){
        ...
        <div class="row row-cols-1 row-cols-md-3 mb-3 ">
          ...
          <div class="col-lg-10">
            <div class="card mb-4 shadow-sm">
            <div class="card-header">
              <h4 class="my-0 fw-normal">Últimas Vendas</h4>
            </div>
            <div class="card-body">
             <form action="verifica_login.php">
              <ul class="list-unstyled mt-3 mb-4">
              <?php
                 ...
                 /*$sql = "select * from vendas order by codVendas desc";
                    $retorno = $con->query($sql);
                      if( $retorno->num_rows > 0){
                            if( $registro = $retorno->fetch_assoc() ){
                             echo "<p><b>Protocolo: </b>" . $registro['codForm'] . "</br>" .
                             "<b>Vendas: </b>" . $registro[''] . "</br>" .
                             "<b>Email: </b>" . $registro[''] . "</br>" .
                             "<b>Telefone: </b>" . $registro[''] . "</br>" .
                              "<hr />" .
                              "</p>";
                           } 
                       }*/
        ...
        <div class="row row-cols-1 row-cols-md-3 mb-3 ">
          ...
          <div class="col-lg-10">
            <div class="card mb-4 shadow-sm">
            <div class="card-header">
              <h4 class="my-0 fw-normal">Último Cadastro de Usuário</h4>
            </div>
            <div class="card-body">
             <form action="verifica_login.php">
              <ul class="list-unstyled mt-3 mb-4">
              <?php
                 ...
                 $sql = "select * from usuarios order by codUser desc";
                    $retorno = $con->query($sql);
                      if( $retorno->num_rows > 0){
                            if( $registro = $retorno->fetch_assoc() ){
