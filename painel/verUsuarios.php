...
<body>
    ...
    font-weight: bold;">
      ...
      <a class="py-2" aria-label="Product" href="home.php">Painel</a>
      <a class="py-2 d-none d-md-inline-block" href="../index.php"><img class="bd-placeholder-img" height="24"  src="../images/logo-c.png" alt=""></a>
    ...
    <center> <h1>Usuários Cadastrados</h1> <hr /> </center>
          ...
          <div class="col-lg-10">
            ...
            <div class="card-body">
             <form action="verifica_login.php">
                    ...
                    $retorno = $con->query($sql);
                      if ( $retorno->num_rows > 0){
                            while( $registro = $retorno->fetch_assoc() ){
                                echo "<p><b>Código: </b>" . $registro['codUser'] . "</br>" .
                                "<b>Usuário: </b>" . $registro['usuario'] . "</br>" .
              ...
              <center>
              <button type="button" class="w-25 btn btn-lg btn-outline-primary" onclick="verUsuarios()">Atualizar</button>
              <button type="button" class="w-25 btn btn-lg btn-outline-primary" onclick="cadastroUsuario()">Novo Usuário</button>
              <button type="button" class="w-25 btn btn-lg btn-outline-primary" onclick="excliurUsuario()">Excluir Usuário</button>
              </center>
              </form>
            </div>
          </div>
